package com.fruitcrm.config;

import com.fruitcrm.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.fruitcrm.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.fruitcrm.repository.search")
