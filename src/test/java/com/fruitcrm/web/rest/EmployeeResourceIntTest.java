...
import com.fruitcrm.repository.EmployeeRepository;
import com.fruitcrm.repository.search.EmployeeSearchRepository;
...
public class EmployeeResourceIntTest {
    ...
    private static final String DEFAULT_F_NAME = "AAAAA";
    private static final String UPDATED_F_NAME = "BBBBB";
    private static final String DEFAULT_L_NAME = "AAAAA";
    private static final String UPDATED_L_NAME = "BBBBB";
    ...
    public void initTest() {
        ...
        employee.setfName(DEFAULT_F_NAME);
        employee.setlName(DEFAULT_L_NAME);
    ...
    public void updateEmployee() throws Exception {
        ...
        // Update the employee
        employee.setfName(UPDATED_F_NAME);
        employee.setlName(UPDATED_L_NAME);
